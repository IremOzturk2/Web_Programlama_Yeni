...
<head >
    ...
    <link rel="stylesheet" href="/Tasarim/css/animate.css">
    
    <link rel="stylesheet" href="/Tasarim/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/Tasarim/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="/Tasarim/css/magnific-popup.css">
    
    <link rel="stylesheet" href="/Tasarim/css/flaticon.css">
...
<body>
    ...
    <div class="hero-wrap" style="background-image: url('/Tasarim/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url(/Tasarim/images/about-1.jpg);">
					</div>
					...
					<div class="col-md-8">
						<div class="tab-content">
						  <div class="tab-pane container p-0 active" id="services-1">
						  	<div class="img" style="background-image: url(/Tasarim/images/services-1.jpg);"></div>
						  	<h3><a href="#">Relation Problem</a></h3>
						  	<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
						  </div>
						  <div class="tab-pane container p-0 fade" id="services-2">
						  	<div class="img" style="background-image: url(/Tasarim/images/services-2.jpg);"></div>
						  	<h3><a href="#">Couples Counseling</a></h3>
						  	<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
						  </div>
						  <div class="tab-pane container p-0 fade" id="services-3">
						  	<div class="img" style="background-image: url(/Tasarim/images/services-3.jpg);"></div>
						  	<h3><a href="#">Depression Treatment</a></h3>
						  	<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
						  </div>
						  <div class="tab-pane container p-0 fade" id="services-4">
						  	<div class="img" style="background-image: url(/Tasarim/images/services-4.jpg);"></div>
						  	<h3><a href="#">Family Problem</a></h3>
						  	<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
						  </div>
						  <div class="tab-pane container p-0 fade" id="services-5">
						  	<div class="img" style="background-image: url(/Tasarim/images/services-5.jpg);"></div>
    ...
    <section class="ftco-section testimony-section">
    	<div class="img img-bg border" style="background-image: url(/Tasarim/images/bg_4.jpg);"></div>
    	<div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center mb-5">
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(/Tasarim/images/person_1.jpg)"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(/Tasarim/images/person_2.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(/Tasarim/images/person_3.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
		...
		<section class="ftco-appointment ftco-section img" style="background-image: url(/Tasarim/images/bg_2.jpg);">
			<div class="overlay"></div>
    	<div class="container">
    		<div class="row">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text text-center">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('/Tasarim/images/image_1.jpg');">
	              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text text-center">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('/Tasarim/images/image_2.jpg');">
	              </a>
	              <div class="meta text-center mb-2 d-flex align-items-center justify-content-center">
                	<div>
                		<span class="day">18</span>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text text-center">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('/Tasarim/images/image_3.jpg');">
	              </a>
	              <div class="meta text-center mb-2 d-flex align-items-center justify-content-center">
                	<div>
                		<span class="day">18</span>
  ...
  <script src="/Tasarim/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="/Tasarim/js/popper.min.js"></script>
  <script src="/Tasarim/js/bootstrap.min.js"></script>
  <script src="/Tasarim/js/jquery.easing.1.3.js"></script>
  <script src="/Tasarim/js/jquery.waypoints.min.js"></script>
  <script src="/Tasarim/js/jquery.stellar.min.js"></script>
  <script src="/Tasarim/js/owl.carousel.min.js"></script>
  <script src="/Tasarim/js/jquery.magnific-popup.min.js"></script>
  <script src="/Tasarim/js/jquery.animateNumber.min.js"></script>
  <script src="/Tasarim/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="/Tasarim/js/google-map.js"></script>
